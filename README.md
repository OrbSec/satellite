...
Node **18+**. Linux or macOS. Current release: **0.1.31**.
...
```bash
npx @orb44/cli@0.1.31 top
npx @orb44/cli@0.1.31 top --interval 1
npx @orb44/cli@0.1.31 top --once    # one frame, then exit
```
...
```bash
npx @orb44/cli@0.1.31 login --url https://app.orb44.com
```
...
```bash
npx @orb44/cli@0.1.31 status
npx @orb44/cli@0.1.31 pulse
npx @orb44/cli@0.1.31 install
orb44 update
npx @orb44/cli@0.1.31 logout
```
