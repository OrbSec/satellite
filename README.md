...
Node **18+**. Linux or macOS. Current release: **0.1.38**.
...
```bash
npx @orb44/cli@0.1.38 top
npx @orb44/cli@0.1.38 top --interval 1
npx @orb44/cli@0.1.38 top --once    # one frame, then exit
```
...
```bash
npx @orb44/cli@0.1.38 status
npx @orb44/cli@0.1.38 pulse
npx @orb44/cli@0.1.38 install
orb44 update
npx @orb44/cli@0.1.38 logout
```
