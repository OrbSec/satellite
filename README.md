...
```bash
npx @orb44/cli@0.1.16 login --url https://app.orb44.com
```
...
```bash
npx @orb44/cli@0.1.16 status
npx @orb44/cli@0.1.16 pulse
npx @orb44/cli@0.1.16 install
orb44 update
npx @orb44/cli@0.1.16 logout
```
