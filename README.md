...
Node **18+**. Linux or macOS. Current release: **0.1.34**.
...
```bash
npx @orb44/cli@0.1.34 top
npx @orb44/cli@0.1.34 top --interval 1
npx @orb44/cli@0.1.34 top --once    # one frame, then exit
```
...
```bash
npx @orb44/cli@0.1.34 login --url https://app.orb44.com
```
...
```bash
npx @orb44/cli@0.1.34 status
npx @orb44/cli@0.1.34 pulse
npx @orb44/cli@0.1.34 install
orb44 update
npx @orb44/cli@0.1.34 logout
```
