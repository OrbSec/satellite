...
const STR = {
  en: {
    ...
    pulse_ok: "Pulse is in the cabinet.\nContinuous monitoring, graphs, Telegram alerts: https://app.orb44.com",
...
Outgoing pulse. Cabinet does not execute commands; it replies with advice.`,
  ...
  ru: {
    ...
    pulse_ok: "Пульс в кабинете.\nНепрерывный мониторинг, графики, алерты в Telegram: https://app.orb44.com",
...
Пульс исходящий. Кабинет не выполняет команды: отвечает текстом «что сделать».`,
  ...
  ko: {
    ...
    key_file: "키: {file}",
    payload: "콘솔로 보내는 내용",
    pulse_ok: "펄스가 콘솔에 있습니다.\n연속 모니터링·그래프·Telegram 알림: https://app.orb44.com",
    pulse_fail: "펄스 거부",
...
나가는 펄스. 콘솔은 명령을 실행하지 않고 조언만 돌려줍니다.`,
  ...
  es: {
    ...
    pulse_ok: "Pulso en el gabinete.\nMonitoreo continuo, gráficos, alertas en Telegram: https://app.orb44.com",
