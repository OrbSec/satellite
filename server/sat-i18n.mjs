...
const STR = {
  en: {
    ...
    plan_satellite: "Dashboard plan does not include the satellite. The pulse was not stored.",
    ...
    grant_on: "on",
    grant_off: "off",
    need_login: "Next: orb44 login --url https://app.orb44.com",
...
Outgoing pulse. The dashboard does not execute commands; it replies with advice.`,
  ...
  ru: {
    ...
    plan_satellite: "В тарифе кабинета нет сателлита. Пульс не записан.",
    ...
    grant_on: "да",
    grant_off: "нет",
    need_login: "Дальше: orb44 login --url https://app.orb44.com",
    key_revoked: "Ключ отозван. Снова: orb44 login",
    daemon_run: "демон каждые {sec}с · {host}",
    daemon_revoked: "ключ отозван",
    unit_written: "unit {path}",
    cli_link: "команда: {path}",
    cli_link_fail: "не удалось поставить команду orb44{err}",
    cli_path_hint: "{dir} нет в PATH. Добавьте и выполните: hash -r",
...
Пульс исходящий. Кабинет не выполняет команды: отвечает текстом «что сделать».`,
  ...
  ko: {
    ...
    key_file: "키: {file}",
    payload: "대시보드로 보내는 내용",
    pulse_ok: "펄스가 대시보드에 있습니다.\n연속 모니터링·그래프·Telegram·Slack 알림: https://app.orb44.com",
    pulse_fail: "펄스 거부",
    plan_satellite: "대시보드 요금제에 위성이 없습니다. 펄스를 저장하지 않았습니다.",
    cabinet_down: "대시보드에 연결할 수 없습니다 ({url}). 대시보드 또는 터널을 올리세요.",
    cabinet_timeout: "대시보드가 응답하지 않습니다 ({url}). 나중에 다시 시도하세요.",
    cabinet_tls: "대시보드 TLS 실패 ({url}).",
    cabinet_dns: "대시보드 호스트를 찾지 못했습니다 ({url}).",
    ...
    grant_on: "켜짐",
    grant_off: "꺼짐",
    need_login: "다음: orb44 login --url https://app.orb44.com",
    ...
    logged_out: "해제됨. 대시보드에서 장치가 제거되었습니다.",
    uninstall_ok: "데몬을 멈추고 unit을 제거했습니다. 페어링 키는 남겼습니다.",
    uninstall_purged: "데몬, 키, 사용자 orb44를 제거했습니다. 대시보드에서 장치를 취소했습니다.",
    ...
    already_kept: "그대로 두었습니다. 펄스를 보냈습니다. 대시보드의 장치는 같습니다.",
...
키: {file}
나가는 펄스. 대시보드은 명령을 실행하지 않고 조언만 돌려줍니다.`,
  },
  es: {
    ...
    key_file: "Clave: {file}",
    payload: "Qué se envía al panel",
    pulse_ok: "Pulso en el panel.\nMonitoreo continuo, gráficos, alertas en Telegram y Slack: https://app.orb44.com",
    pulse_fail: "pulso rechazado",
    plan_satellite: "El plan del panel no incluye el satélite. El pulso no se guardó.",
    cabinet_down: "El panel no responde ({url}). Levante el panel o el túnel.",
    cabinet_timeout: "El panel no contestó ({url}). Pruebe más tarde.",
    cabinet_tls: "Falló TLS al panel ({url}).",
    cabinet_dns: "No se resuelve el host del panel ({url}).",
    ...
    grant_on: "sí",
    grant_off: "no",
    need_login: "Siguiente: orb44 login --url https://app.orb44.com",
    key_revoked: "Clave revocada. Otra vez: orb44 login",
    daemon_run: "demonio cada {sec}s · {host}",
    daemon_revoked: "clave revocada",
    unit_written: "unit {path}",
    cli_link: "comando instalado: {path}",
    cli_link_fail: "no se pudo instalar el comando orb44{err}",
    cli_path_hint: "{dir} no está en PATH. Añádalo, luego: hash -r",
    ...
    logged_out: "Desconectado. El panel quitó el dispositivo.",
    uninstall_ok: "Demonio parado y unit quitado. Se guarda la clave de emparejamiento.",
    uninstall_purged: "Demonio, clave y usuario orb44 eliminados. El panel revocó el dispositivo.",
    ...
    already_kept: "Se dejó igual. Pulso enviado. El mismo dispositivo en el panel.",
